...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2024 at 09:54 AM
...
(1, 'KIU1', 'Abacell 18 EC 10 X 1 ltr', 10, 0, '01/07/2026', 100, 1, 'StockOpname', '', ''),
(2, 'KIU2', 'Abacell 18 EC 40 X 250 ml', 0, 50, '01/12/2026', 50, 1, 'StockOpname', '', ''),
(4, 'KIU1', 'Abacell 18 EC 10 X 1 ltr', 0, 50, '01/07/2026', 50, 2, 'StockOpname', '', '');
...
--
ALTER TABLE `tb_opname`
  MODIFY `id_opname` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
