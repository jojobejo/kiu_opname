    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('opnameEdited') ?>" method="POST" id="form_edit_opname" class="form-horizontal">
                    <?php echo form_open_multipart('opnameEdited'); ?>
                    <div class="form-group" hidden>
                        <div class="row">
                            <label class="col-sm-3 control-label text-right" for="id_bar">id<span class="required">*</span></label>
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="id_isi" name="id_isi" value="" hidden />
                    ...
                    <div class="form-group" hidden>
                        <div class="row">
                            ...
                            <div class="col-sm-8"><input class="form-control" type="number" id="dimensi_isi" name="dimensi_isi" value="" min="0" hidden /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="number" id="box_isi" name="box_isi" value="" min="0" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8"><input class="form-control" type="number" id="pcs_isi" name="pcs_isi" value="" min="0" /></div>
                        </div>
                    </div>
            </div>
