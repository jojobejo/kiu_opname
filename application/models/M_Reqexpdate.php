...
class M_Reqexpdate extends CI_Model
{
    ...
    public function barangreq($id_tmp)
    {
        $this->db->from('tb_rq_exp_tmp');
        $this->db->where('id_tmp_req', $id_tmp);
        return $this->db->get()->result();
    }
    public function inputdatazahir($data)
    {
        return $this->db->insert('tb_barang_zahir', $data);
    }
    public function insertopnameexp($data)
    {
        return $this->db->insert('tb_opname', $data);
    }
    public function updatestatusrq($id, $data)
    {
        $this->db->where('id_tmp_req', $id);
        return $this->db->update('tb_rq_exp_tmp', $data);
    }
}
