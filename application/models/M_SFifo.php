...
class M_SFifo extends CI_Model
{
    ...
    var $column_order = array('nama_barang', 'exp_date', 'faktur_pending', 'saldo_buku', 'box_buku', 'pcs_buku', 'saldo_fisik', 'box_fisik', 'pcs_fisik', 'selisih', 'sektor','hasil'); //field yang ada di table user
